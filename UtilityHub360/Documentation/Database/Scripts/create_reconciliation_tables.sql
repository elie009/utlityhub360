...
-- Description: Creates tables for bank statement import and reconciliation workflow
-- Date: 2024
-- =============================================
...
-- Mark migration as applied (if __EFMigrationsHistory table exists)
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[__EFMigrationsHistory]') AND type in (N'U'))
BEGIN
    IF NOT EXISTS (SELECT * FROM [dbo].[__EFMigrationsHistory] WHERE [MigrationId] = N'20250101000000_AddReconciliationTables')
    BEGIN
        INSERT INTO [dbo].[__EFMigrationsHistory] ([MigrationId], [ProductVersion])
        VALUES (N'20250101000000_AddReconciliationTables', N'8.0.0');
    END
END
GO

PRINT 'Reconciliation tables created successfully!';
GO
