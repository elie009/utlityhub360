...
namespace UtilityHub360.Services
{
    public interface IBillService
    {
        ...
        Task<ApiResponse<BillDto>> ConfigureScheduledPaymentAsync(string billId, string userId, ConfigureScheduledPaymentDto config);
        Task<ApiResponse<List<ScheduledPaymentDto>>> GetScheduledPaymentsAsync(string userId);

        // Bill Approval Operations
        Task<ApiResponse<BillDto>> ApproveBillAsync(string billId, string userId, BillApprovalDto approval);

        // Payment History Reports
        Task<ApiResponse<BillPaymentHistoryReportDto>> GetBillPaymentHistoryReportAsync(string userId, string period = "month");
    }
}
