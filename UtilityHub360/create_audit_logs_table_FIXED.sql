-- ==========================================
-- AUDIT LOGS TABLE CREATION (FIXED VERSION)
-- ==========================================
...
BEGIN
    ...
    BEGIN
        ...
        ELSE
        BEGIN
            PRINT 'ERROR: AuditLogs table does not exist. Cannot create foreign key.';
        END
    END
    ELSE
    BEGIN
...
ELSE
BEGIN
    PRINT 'ERROR: AuditLogs table does not exist. Cannot create indexes.';
    PRINT 'Please ensure the AuditLogs table was created successfully before running index creation.';
END
GO

PRINT '==========================================';
PRINT 'Audit Logs table and indexes creation completed';
PRINT '==========================================';
GO
